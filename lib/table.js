...
Table.prototype = {
    ...
    _create: co(function*(dto) {
        ...
        var res = yield DB.executeQuery(q);
        return res['insertId'];
    }),
    ...
    update: co(function*(row, dto) {
        ...
        if (this._supportOptimisticLock()) {
            ...
            cond = DB.format('version = ?', [version]);
        }
    ...
    find: co(function*(queryBuilder) {
        ...
        var res = yield DB.executeQuery(query.toS()); 
        return res;
    }),
    ...
    findById: co(function*(id) {
        ...
        return (yield this.findFirst(function(q, t) {
    ...
    lockById: co(function*(id) {
        ...
        var res = yield DB.executeQuery(qstr);
        return res;
    }),
